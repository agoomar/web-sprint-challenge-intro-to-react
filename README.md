...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  - React JS is a JavaScript library that helps build UI components, it allows us to build it with interactive components by using useState and useEffects.

1. Describe component state.
  - Component state is just the current data out of a component, that will change over time.

1. Describe props.
  - Props is just an object argument for components.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  - Side effects are just that cause of an action invoked by the user, which you can sync effect ina react component by using useEffect hook.
